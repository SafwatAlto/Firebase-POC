...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/Fat3HtEC8S)
...
```sh
npx nx serve FMobile
```

To create a production bundle:

```sh
npx nx build FMobile
```

To see all available targets to run for a project, run:

```sh
npx nx show project FMobile
```
